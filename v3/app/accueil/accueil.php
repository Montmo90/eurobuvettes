...
<body onload="accueil()" class="vh-100 d-flex flex-column">
    ...
    <!--        Main            -->
    <main class="mainAccueil container">
        <section class="accueil row" id="buvettes">
            ...
            <aside class="annexeAccueil col-lg-4" style="background-color: gray;">
                ...
                <hr class="asideBarre">
                <p>11/06/2021 : Le Championnat d'Europe de football 2020 commence !</p>
                <p>25/02/2021 : Bientôt de nouveaux matchs, tenez vous prêts pour cette nouvelle saison.</p>
                <p>15/01/2021 : Excellents retours sur les precedentes sessions, continuez ainsi !</p>
